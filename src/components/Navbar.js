  ...
  return (
    <div className="bg-yt-black h-14 flex items-center pl-4 pr-5 justify-between fixed w-full z-10 ">
      ...
      <div className="h-10 flex flex-row items-center ">
        <div className="w-[593px] bg-yt-black lg:flex border border-yt-light-black items-center rounded-3xl h-10">
          <input
            type="text"
            placeholder="Search"
            className="w-full bg-yt-black h-6 ml-6 text-yt-white text-start focus:outline-none pl-4"
          />
          <button className="w-16 h-10 bg-yt-light-black px-2 py-0.5 rounded-r-3xl border-l-2 border-yt-black">
            <HiMagnifyingGlass
              size={22}
      ...
      <div className="flex items-center justify-center ">
        <div className="flex flex-row items-center">
          ...
          <div className="mx-3 px-2 w-10 hover:bg-yt-light-black rounded-full cursor-pointer">
            <FaRegBell
            size={20}
